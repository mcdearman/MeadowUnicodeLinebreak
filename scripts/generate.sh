#!/bin/sh
# Regenerate src/Tables.mw and src/Cases.mw from the unicode-linebreak crate.
#
#   scripts/generate.sh
#
# The crate version is pinned in scripts/generate/Cargo.toml. To move to a new
# one, change the pin and run this: if the crate's driver in src/lib.rs has changed,
# the generator stops and says so, and src/Break.mw has to be brought into
